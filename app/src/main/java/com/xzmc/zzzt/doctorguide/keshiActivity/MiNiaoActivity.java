...
public class MiNiaoActivity extends TopBarBaseActivity implements View.OnClickListener{
    Button btn1;
    Button btn2;
    Button btn3;
    Button btn4;
    ...
    protected int getConentView() {
        return R.layout.activity_miniao;
    }
            ...
            new SweetAlertDialog(this).setTitleText("挂号")
                    ...
                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        ...
                        public void onClick(
                            ...
                            new SweetAlertDialog(MiNiaoActivity.this, SweetAlertDialog.SUCCESS_TYPE)
