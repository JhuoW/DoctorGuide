...
/**
 * Created by enritami on 17/6/11.
 */

public class ShenjinActivity extends TopBarBaseActivity implements View.OnClickListener{
    Button btn1;
    Button btn2;
    Button btn3;
    Button btn4;
    ...
    protected int getConentView() {
        return R.layout.activity_shenjin;
    }
            ...
            new SweetAlertDialog(this).setTitleText("挂号")
                    ...
                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        ...
                        public void onClick(
                            ...
                            new SweetAlertDialog(ShenjinActivity.this, SweetAlertDialog.SUCCESS_TYPE)
