...
public class XinXueGuanActivity extends TopBarBaseActivity implements View.OnClickListener {
    Button btn1;
    Button btn2;
    Button btn3;
    Button btn4;
    ...
    protected int getConentView() {
        return R.layout.actvity_xinxueguan;
    }
            ...
            new SweetAlertDialog(this).setTitleText("挂号")
                    ...
                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        ...
                        public void onClick(
                            ...
                            new SweetAlertDialog(XinXueGuanActivity.this, SweetAlertDialog.SUCCESS_TYPE)
